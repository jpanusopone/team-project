...
The main LLM used to analyze possible phishing emails.

### DeepSeekAI

The fallback LLM if the OpenAI API does not work.

### Google Safe Browsing

Used to check the safety of links.

### FireBase

Database used to store all emails. 

### Discord Webhook API

For sending messages on new phishing emails.
...
^ After filtering emails.

![img_4.png](img_4.png)

^ If the user chooses to join the discord server.
...
^ After the user successfully logs in through the IT login.

![img_8.png](img_8.png)

^ After clicking on an email within the IT dashboard.
